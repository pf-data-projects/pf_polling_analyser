...
def trim_table(data, start, end, comments):
    ...
    for comment in comments:
        ...
        data_row_index = data[
            (data['Base Type'] == "Question") &
            (data['IDs'] == str(comment[0]))
        ].index
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Find index for first and last rows
    ...
    # ~~~~~~~~~~ Trim DataFrame to only include rows between the found indices
...
def create_grid_summaries(data):
    ...
    for qid in unique_ids:
        ...
        options_list = table_options_list
